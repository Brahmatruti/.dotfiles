...
# Print Section Title
#==================================
print_section "Running Debian Dotfiles Setup"
...
echo
if [[ $REPLY =~ ^[Yy]$ ]]; then
    . "$HOME/.dotfiles/system/debian/setup_nfs.sh"
fi

# setup fonts
. "$HOME/.dotfiles/system/debian/setup_fonts.sh"

# setup defaults
. "$HOME/.dotfiles/system/debian/setup_defaults.sh"

# setup shell
. "$HOME/.dotfiles/system/debian/setup_shell.sh"
